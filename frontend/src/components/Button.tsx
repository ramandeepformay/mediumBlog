...
const Button = ({ label, onClick, loading }: buttonType) => {
    return <div>
        {
            loading ? <div>

                <button type="button" className="text-center w-full border bg-black text-white py-2 rounded-md cursor-pointer" onClick={onClick}>{label}<Spinner/></button>
            </div>
...
const Spinner = function () {
    return <>
        <div className="display: inline ml-4" role="status">
